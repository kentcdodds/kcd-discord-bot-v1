...
async function handleGuildMemberUpdate(oldMember, newMember) {
  ...
  if (hasRocket && !isEpicReactMember) {
    ...
    await botsChannel.send(
      `
Hi ${newMember.user}, I noticed you tried to add a rocket to your nickname. I'm afraid you can't do this because your discord account is not connected to your EpicReact.Dev account. Go to <https://epicreact.dev/discord> to make that connection.
